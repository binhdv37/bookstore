...
<head>
    ...
    <title>Userorder - Delivering</title>
        ...
        <div class="col-10 p-0" style="margin-bottom: 20%;">
            ...
            <div class="container-fluid p-0 my-3">
                <ul class="nav nav-tabs lead text-center">
                    ...
                    <li class="nav-item w-25">
                        <a class="nav-link active text-danger disabled" href="a-vieworder-${requestScope.userid}-2">Delivering</a>
                    </li>
                    <li class="nav-item w-25">
                ...
                <c:forEach items="${requestScope.itemList}" var="item">
                    ...
                    <div class="collapse" id="item${item.id}">
                        <form method="post" class="form-inline" action="">
                            ...
                            <a href="a-confirmdelivered-${requestScope.userid}-${item.id}" class="btn btn-primary ml-sm-5 mb-2">Confirm delivered</a>
                        </form>
                    </div>
