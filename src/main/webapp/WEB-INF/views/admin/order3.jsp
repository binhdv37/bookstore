...
<head>
    ...
    <title>Userorder - Delivered</title>
        ...
        <div class="col-10 p-0" style="margin-bottom: 20%;">
            ...
            <div class="container-fluid p-0 my-3">
                <ul class="nav nav-tabs lead text-center">
                    ...
                    <li class="nav-item w-25">
                        <a class="nav-link active text-danger disabled" href="a-vieworder-${requestScope.userid}-3">Delivered</a>
                    </li>
                    <li class="nav-item w-25">
                        <a class="nav-link " href="a-vieworder-${requestScope.userid}-4">Canceled</a>
                    </li>
                </ul>
            </div>
            <!-- end of navigate bar-->
            ...
            <div class="container p-0">
                ...
                <c:forEach items="${requestScope.itemList}" var="item">
                    ...
                    <div class="row text-center p-3 my-5 lead ctm-item">
                        ...
                        <!--action-->
                        <div class="col-2 my-auto">
                            <a href="#item${item.id}" class="btn btn-outline-dark" data-toggle="collapse" >Detail</a>
                        </div>
                    </div>
                    <!-- end of item 1 -->
                    ...
                    <div class="collapse" id="item${item.id}">
                        <form class="form-inline" >
                            ...
                            <input type="text" id="placedtime" disabled class="form-control mb-2 mr-sm-4" value="${item.placedTime}">
                            <label for="shiptime" class="mr-sm-2">Intend ship time:</label>
                            <input id="shiptime" disabled type="number" class="form-control mb-2 mr-sm-1" value="${item.shippedTime}"/>day
                            <label for="deliveredtime" class="mr-sm-2 ml-sm-4">Deliverd time:</label>
                            <input id="deliveredtime" disabled type="text" class="form-control mb-2 mr-sm-1" value="${item.deliveredTime}"/>
                        </form>
                    </div>
