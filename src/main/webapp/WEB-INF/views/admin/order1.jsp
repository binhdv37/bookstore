...
<head>
    ...
    <title>Userorder - wating for confirmation</title>
            ...
            <div class="container-fluid p-0 my-3">
                <ul class="nav nav-tabs lead text-center">
                    <li class="nav-item w-25">
                        <a class="nav-link active text-danger disabled" href="a-vieworder-${requestScope.userid}-1">Waiting for confirmation</a>
                    </li>
                    <li class="nav-item w-25">
            ...
            <div class="container p-0">
                ...
                <c:forEach items="${requestScope.itemList}" var="item">
                    ...
                    <div class="collapse" id="item${item.id}">
                        <form method="post" class="form-inline" action="a-confirm-${requestScope.userid}-${item.id}">
                            ...
                            <label for="shiptime" class="mr-sm-2">Enter intend ship time:</label>
                            <input name="shiptime" id="shiptime" type="number" class="form-control mb-2 mr-sm-1" required/>day
                            <button type="submit" class="btn btn-primary ml-sm-5 mb-2">Confirm order</button>
                        </form>
                    </div>
