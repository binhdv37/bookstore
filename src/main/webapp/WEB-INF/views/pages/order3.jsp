...
<div class="container">
    <ul class="nav nav-tabs lead text-center">
        <li class="nav-item w-25">
            <a class="nav-link " href="order-1">Waiting for confirmation</a>
        </li>
        <li class="nav-item w-25">
            <a class="nav-link " href="order-2">Delivering</a>
        </li>
        <li class="nav-item w-25">
            <a class="nav-link active text-success disabled" href="order-3">Delivered</a>
        </li>
        <li class="nav-item w-25">
...
<div class="container p-0">
    ...
    <c:forEach items="${requestScope.itemList}" var="item">
        ...
        <div class="row text-center p-3 my-5 lead ctm-item">
            ...
            <!--action-->
            <div class="col-2 my-auto">
                <a href="#item${item.id}" class="btn btn-outline-dark" data-toggle="collapse">View Detail</a>
            </div>
        </div>
        <!-- end of item 1 -->
        ...
        <div class="collapse" id="item${item.id}">
            <form class="form-inline">
                ...
                <input name="shiptime" disabled id="shiptime" type="text" value="${item.shippedTime}" class="form-control mb-2 mr-sm-1" />day
                <label for="deliveredtime" class="mr-sm-2 ml-sm-4">Delivered time:</label>
                <input name="shiptime" disabled id="deliveredtime" type="text" value="${item.deliveredTime}" class="form-control mb-2 mr-sm-1" />
            </form>
        </div>
